<?php
	...
	$query = mysql_query("SELECT ({$_count}) AS count,titleid,user,comment,date FROM comment WHERE titleid ='{$_POST['titleid']}' ORDER BY date DESC LIMIT {$_limit},{$_pagesize}") or die ('SQL错误！');
